...
public class StudentQueueTest {
	...
	@Test
	public void testDequeueFim() throws QueueUnderflowException {
		queue2.dequeue();
		queue2.dequeue();
	...
	@Test
	public void circular() throws QueueOverflowException, QueueUnderflowException {
		...
		assertEquals(new Integer(6), queue1.dequeue());
